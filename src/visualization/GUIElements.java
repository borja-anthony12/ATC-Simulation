...
public class GUIElements extends JFrame {
    ...
    JComboBox<Integer> changeGateAmount; // Creates a JCombo box for changing the number of gates
    JComboBox<Integer> changeRunwayAmount; // Creates a JCombo box for changing the number of planes
    // Creates JLabels
    ...
    private JComboBox<Integer> createChangeGateAmount() {
        ...
        changeGateAmount = new JComboBox<>(setGateAmount); // Creates JCombo box (Drop down) and sets the value to
        // setGateAmount list
        ...
        changeGateAmount.addActionListener(e -> {
            if (changeGateAmount.getSelectedItem() != null && airportVisuals != null) {
                ...
                System.out.println("Change Gate Amount is null");
                System.out.println("Airport Visuals is null");
            }
        });
    ...
    private JComboBox<Integer> createChangeRunwayAmount() {
        // Creates JComboBox for setting the number of gates
        changeRunwayAmount = new JComboBox<>(setRunwayAmount); // Creates JCombo box (Drop down)
        // and sets the value to setGateAmount list
        ...
        changeRunwayAmount.addActionListener(e -> {
            if (changeRunwayAmount.getSelectedItem() != null && airportVisuals != null) {
                runwayAmount = (int) changeRunwayAmount.getSelectedItem(); // Sets gateAmount to the selected item from the JComboBox(Dropdown)
                airportVisuals.getRunwayAmount(runwayAmount);
            } else {
                System.out.println("Change Runway Amount is null");
                System.out.println("Airport Visuals is null");
            }
        });
    ...
    private JButton createAddPlane() {
        ...
        addPlane.addActionListener(e -> {
            ...
            tower.spawnPlane(); // Spawns a plane and places it on JPanel
        });
    ...
    class AirportPanel extends JPanel {
        ...
        private static final Logger logger = Logger.getLogger(AirportPanel.class.getName());
        ...
        protected void paintComponent(Graphics g) {
            ...
            try {
                ...
                logger.log(Level.SEVERE, "An error occurred while drawing planes", e);
            }
        }
        ...
        public void drawAirportBuilding() {
            ...
            int centreXBuilding = getCentredPos[0]; // Calculates the building centre.
            // (350 is what got to the position I wanted)
            int centreYBuilding = getCentredPos[1]; // Calculates the building centre.
            // (115 is what got the position on I wanted)
